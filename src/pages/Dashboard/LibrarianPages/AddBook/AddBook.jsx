...
const AddBook = () => {
  ...
  const handleBookSubmit = async (data) => {
    // console.log(data)
    const { bookName, author, image, price, status, category, description } =
      data;
      ...
      <div className="card bg-base-100 shadow-xl p-8">
        ...
        >
          ...
          <div className="form-control">
            ...
            />
            {errors.bookName && (
              <span className="text-red-500 mt-1">BooK Name is required</span>
            )}
          </div>
          ...
          <div className="form-control">
            ...
            />
            {errors.author && (
              <span className="text-red-500 mt-1">Author Name is required</span>
            )}
          </div>
          ...
          <div className="form-control md:col-span-2">
            ...
            />
            {errors.image && (
              <span className="text-red-500 mt-1">Image field is required</span>
            )}
          </div>
          ...
          <div className="form-control">
            ...
            {errors.status && (
              <span className="text-red-500 mt-1">
                Book status should be public or private
              </span>
            )}
          </div>
